 ...
 * @version $Date: 2004-07-09 12:40:50 +0200 (ven, 09 lug 2004) $ $Revision:
 *          5199 $
 */
...
//  knowFrame.setTitle("view known");
		...
		sPane = new JScrollPane(listNames, ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS,
	...
	void miRegWithDF_Action(java.awt.event.ActionEvent event) { // Register with a DF
		...
		/*
		 * labelInsertDF.setVisible(true); textFieldDFaddress.setVisible(true);
		 */
	...
	/**
	 * This method sets to not visible all the components of this frame except the
	 * Menu Bar.
	 */
	void clearFrame() {
		knowFrame.setVisible(false);
