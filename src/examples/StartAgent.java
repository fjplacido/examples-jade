...
import tutorial.exemplo_01.HelloWorld;

/**
 * Class that starts the <b>{@link HelloWorld}</b> agent.
 * 
...
public class StartAgent {
	...
	public static void main(String[] args) {
		...
		new StartAgent(new HelloWorldAgent(), "helloworld", "hello-agent-container");
